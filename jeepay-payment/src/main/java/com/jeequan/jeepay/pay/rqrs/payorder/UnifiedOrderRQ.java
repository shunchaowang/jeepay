...
public class UnifiedOrderRQ extends AbstractMchAppRQ {
  ...
  public UnifiedOrderRQ buildBizRQ() {
    ...
    if (CS.PAY_WAY_CODE.ALI_BAR.equals(wayCode)) {
      ...
      BeanUtils.copyProperties(this, bizRQ);
      return bizRQ;
    } else if (PAY_WAY_CODE.EMS_DIRECT.equals((wayCode))) {
      EmsDirectOrderRQ bizRQ = JSONObject.parseObject(
          StringUtils.defaultIfEmpty(this.channelExtra, "{}"), EmsDirectOrderRQ.class);
      BeanUtils.copyProperties(this, bizRQ);
      return bizRQ;
    }
