...
public class ConfigContextQueryService {
  ...
  public NormalMchParams queryNormalMchParams(String mchNo, String mchAppId, String ifCode) {
    ...
    return NormalMchParams.factory(payInterfaceConfig.getIfCode(),
  ...
  public IsvsubMchParams queryIsvsubMchParams(String mchNo, String mchAppId, String ifCode) {
    ...
    return IsvsubMchParams.factory(payInterfaceConfig.getIfCode(),
        payInterfaceConfig.getIfParams());
  }
  ...
  public AlipayClientWrapper getAlipayClientWrapper(MchAppConfigContext mchAppConfigContext) {
    ...
    if (isCache()) {
      return
          configContextService.getMchAppConfigContext(mchAppConfigContext.getMchNo(),
              mchAppConfigContext.getAppId()).getAlipayClientWrapper();
    }

    if (mchAppConfigContext.isIsvsubMch()) {

      AlipayIsvParams alipayParams = (AlipayIsvParams) queryIsvParams(
  ...
  public WxServiceWrapper getWxServiceWrapper(MchAppConfigContext mchAppConfigContext) {
    ...
    if (mchAppConfigContext.isIsvsubMch()) {
      ...
      WxpayIsvParams wxParams = (WxpayIsvParams) queryIsvParams(
  ...
  public PaypalWrapper getPaypalWrapper(MchAppConfigContext mchAppConfigContext) {
    if (isCache()) {
      return
          configContextService.getMchAppConfigContext(mchAppConfigContext.getMchNo(),
              mchAppConfigContext.getAppId()).getPaypalWrapper();
    }
    PppayNormalMchParams ppPayNormalMchParams = (PppayNormalMchParams) queryNormalMchParams(
        mchAppConfigContext.getMchNo(), mchAppConfigContext.getAppId(), CS.IF_CODE.PPPAY);
    ;
    return PaypalWrapper.buildPaypalWrapper(ppPayNormalMchParams);

  }

  public EmsWrapper getEmsWrapper(MchAppConfigContext mchAppConfigContext) {
    if (isCache()) {
      return configContextService.getMchAppConfigContext(mchAppConfigContext.getMchNo(),
          mchAppConfigContext.getAppId()).getEmsWrapper();
    }

    EmspayNormalMchParams emspayNormalMchParams = (EmspayNormalMchParams) queryNormalMchParams(
        mchAppConfigContext.getMchNo(), mchAppConfigContext.getAppId(), CS.IF_CODE.EMSPAY);
    return EmsWrapper.buildEmsWrapper(emspayNormalMchParams);
  }
